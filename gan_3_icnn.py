...
def main():
    ...
    Discriminator_p = ICNN(input_dim = 1, hidden_dim = 32, output_dim = 1).to(device)
    Discriminator_n = ICNN(input_dim = 1, hidden_dim = 32, output_dim = 1).to(device)
    SurrogatePhysics = ICNN(input_dim=param_dims, hidden_dim = 64, output_dim = 1).to(device)
